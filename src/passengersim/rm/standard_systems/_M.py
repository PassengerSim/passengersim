...
class M(RmSys):
    ...
    References
    ----------
    Fiig, T., Isler, K., Hopperstad, C., & Belobaba, P. (2010). "Optimization
    of mixed fare structures: Theory and applications." Journal of Revenue
    and Pricing Management, 9(1/2), 152-170.
    """
